...
function theme_setup() {
	...
	*  sizes with add_image_size. */
	...
	add_image_size('logo-large', 730, 280, false);
	add_image_size('bio', 1080, 1290, true);
	add_image_size('square', 1300, 1300, true);
	...
	add_image_size('home-work', 2700, 1400, true);
...
function hackeryou_scripts() {
  ...
  wp_enqueue_script(
   ...
   wp_enqueue_style( 'animate', get_stylesheet_directory_uri() . '/js/animate.css', array(), '1.5.9' );
      ...
      // scroll reveal
   wp_enqueue_script( 'wow-js-js', get_template_directory_uri() . "/js/wow.js", array( 'jquery' ), '1.5.9', true );
